...
namespace Bolao.Domain.Domains.Validator
{
    public sealed class LotteryValidator : AbstractValidator<Lottery>
    {
        public LotteryValidator()
        {
            ...
            RuleFor(x => x.ListNumbersResult).Must((arg, ValidateLimitNumbers) => this.ValidateLimitNumbers(arg.ListNumbersResult, arg.TypeBetId)).WithMessage(Msg.InvalidLimitNumbers);
        }
